...
const ICON_PATHS = {
  ...
  fish:'<path d="M3 12c2.8-3.8 6.2-5.5 9.8-5.5 2.5 0 4.7 1 6.4 2.6L21 7v10l-1.8-2.1c-1.7 1.6-3.9 2.6-6.4 2.6C9.2 17.5 5.8 15.8 3 12Z"/><circle cx="9" cy="10.8" r=".9"/><path d="M14 12h3"/>',
  squid:'<path d="M12 3c2.6 0 4 2.2 4 5.2v3.3c0 1.4.7 2 1 3.5M12 3c-2.6 0-4 2.2-4 5.2v3.3c0 1.4-.7 2-1 3.5M12 11.5V21M9.5 13v6.5M14.5 13v6.5"/>',
  rings:'<circle cx="9.5" cy="12" r="5"/><circle cx="9.5" cy="12" r="1.6"/><circle cx="17" cy="12" r="3.4"/>',
  shrimp:'<path d="M18.5 5.5c-7 0-11.5 3.4-11.5 8.5 0 3 2 5 4.8 5H18"/><path d="M7 14.5C4.6 14.5 3 13 3 11M11 19l-1.2 2M14 19l-.6 2"/><circle cx="17.5" cy="8" r="1"/>',
  roe:'<circle cx="9" cy="10" r="2.1"/><circle cx="14.5" cy="9" r="2.1"/><circle cx="11.5" cy="14.3" r="2.1"/><circle cx="16.8" cy="14" r="2.1"/>',
  utensils:'<path d="M6 3v6.5a2 2 0 0 0 4 0V3M8 9.5V21M16 3c-1.8 0-2.8 2-2.8 4.8 0 2.4 1 3.7 2.8 3.7V21"/>',
};
