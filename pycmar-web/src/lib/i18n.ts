...
const t_data: Record<Lang, Dict> = {
  es: {
    ...
    legal_privacy:"Políticas de Privacidad", legal_shipping:"Políticas de Envío",
    legal_terms:"Términos y Condiciones", legal_claims:"Libro de Reclamaciones",
    legal_zones:"Zonas de Despacho", legal_updated:"Última actualización:",
    legal_zone_available:"Disponible", legal_zone_consult:"Consultar",
    legal_zone_time:"Plazo:",
    claims_consumer:"Datos del consumidor", claims_detail:"Detalle del reclamo",
    claims_type_claim:"Reclamo (producto/servicio)", claims_type_complaint:"Queja (atención al cliente)",
    claims_solution:"¿Qué solución esperas?", claims_submit:"Enviar reclamo",
    claims_note:"Al enviar este formulario, Pycmar se compromete a dar respuesta dentro de los 30 días calendario establecidos por ley.",
    claims_alt:"También puedes contactarnos directamente:",
    claims_incident:"Fecha del incidente",
  },
  en: {
    ...
    legal_privacy:"Privacy Policy", legal_shipping:"Shipping Policy",
    legal_terms:"Terms & Conditions", legal_claims:"Complaints Book",
    legal_zones:"Delivery Zones", legal_updated:"Last updated:",
    legal_zone_available:"Available", legal_zone_consult:"Enquire",
    legal_zone_time:"Lead time:",
    claims_consumer:"Consumer information", claims_detail:"Complaint details",
    claims_type_claim:"Complaint (product/service)", claims_type_complaint:"Grievance (customer service)",
    claims_solution:"What resolution do you expect?", claims_submit:"Submit complaint",
    claims_note:"By submitting this form, Pycmar commits to responding within 30 calendar days as required by law.",
    claims_alt:"You can also contact us directly:",
    claims_incident:"Date of incident",
  },
  zh: {
    ...
    legal_privacy:"隐私政策", legal_shipping:"配送政策",
    legal_terms:"条款与条件", legal_claims:"投诉登记",
    legal_zones:"配送区域", legal_updated:"最后更新：",
    legal_zone_available:"可配送", legal_zone_consult:"请咨询",
    legal_zone_time:"时效：",
    claims_consumer:"消费者信息", claims_detail:"投诉详情",
    claims_type_claim:"投诉（产品/服务）", claims_type_complaint:"意见（客户服务）",
    claims_solution:"您期望的解决方案？", claims_submit:"提交投诉",
    claims_note:"提交此表格后，Pycmar承诺在法律规定的30个日历日内作出答复。",
    claims_alt:"您也可以直接联系我们：",
    claims_incident:"事件日期",
  },
};
