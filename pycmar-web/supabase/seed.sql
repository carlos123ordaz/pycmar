-- ============================================================
-- PYCMAR — Seed completo (34 productos del catálogo oficial)
...
-- ── POTA / GIANT SQUID (14 productos) ───────────────────────
insert into public.products
  (slug, category_id, name_es, name_en, scientific_name, description_es, description_en, blurb_es, blurb_en,
   price, tags, origin, fao_zone, presentation, packaging, sizing, measures, featured, retail, active)
values

('botones',
  (select id from categories where slug='pota'),
...
('filete',
  ...
  'Manto abierto en lámina entera. Base para anillas, tiras y porciones a medida.',
  'Open whole mantle sheet. The base for rings, strips and custom portions.',
  14.00, ARRAY['Bloque'],'Perú','87',
  'Con membrana y telilla o sin',
  'Saco de 20 kg: 2 bloques de 10 kg',
  'De 1 a 2 kg · de 2 a 4 kg','Grosor 1,8–2,3 cm',
  true, true, true),
...
('daruma',
  ...
  'Filete precocido estilo japonés, listo para mercados premium de Asia.',
  'Japanese-style pre-cooked fillet, ready for premium Asian markets.',
  19.00, ARRAY['Bloque','Cocido'],'Perú','87',
  'Cocido · sin membrana ni telilla',
  'Saco de 21 kg: 3 bloques de 7 kg',
  null,'Grosor 0,8–1,2 cm',
  false, true, true),
...
('steak-oval',
  ...
  'Steak ovalado de corte limpio, presentación de retail.',
  'Clean-cut oval steak, retail-ready presentation.',
  17.50, ARRAY['IQF'],'Perú','87',
  'Sin membrana ni telilla',
  'Caja de 30 lb: 6 cajas de 5 lb',
  null,'Grosor 0,85–1,2 cm',
  false, true, true),
...
('valencia',
  ...
  'Corte rectangular calibrado para el mercado español.',
  'Calibrated rectangular cut for the Spanish market.',
  15.50, ARRAY['Bloque'],'Perú','87',
  'Sin membrana ni telilla',
  'Saco/caja de 20 kg (2×10 kg) · 22,5 kg (3×7,5 kg)',
  null,'Largo 15–25 cm · ancho 8–12 cm · grosor 0,8–1,2 cm',
  false, true, true),
...
('anillas',
  ...
  'Anillas calibradas, blancas o amarillas, para empanizado y conserva.',
  'Calibrated rings, white or yellow, for breading and canning.',
  18.00, ARRAY['IQF','Bloque'],'Perú','87',
  'Anillas blancas o amarillas, con o sin membrana',
  'Bloque 26 kg (4×6,5 kg) · IQF a granel 10 kg (4×2,5 kg)',
  null,'Diám. ext. 4,5–7 cm · int. 2,2–4,5 cm',
  true, true, true),
...
('alas',
  ...
  'Aleta lateral del manto, textura firme y rendidora.',
  'Lateral mantle fin, firm and high-yield.',
  12.50, ARRAY['Bloque'],'Perú','87',
  'Enteras, corte por la mitad o en cruz',
  'Saco de 20 kg: 2 bloques de 10 kg',
  '300 gr a más', null,
  false, true, true),
...
('nucas',
  ...
  'Unión cabeza-manto, carnosa, para guisos y mixturas.',
  'Head-mantle joint, meaty, for stews and blends.',
  13.00, ARRAY['Bloque'],'Perú','87',
  null,
  'Saco de 20 kg: 2 bloques de 10 kg',
  '100–300 · 300–500 · 500–700 gr · 700 gr a más', null,
  false, true, true),
...
('tentaculos',
  ...
  'Corte bailarina limpio, sin uñas ni ventosas.',
  'Clean ballerina cut, no nails or suckers.',
  13.50, ARRAY['Bloque'],'Perú','87',
  'Corte bailarina, sin uñas ni ventosas',
  'Saco de 20 kg: 2 bloques de 10 kg',
  null, null,
  false, true, true),
...
('rodaja-rejo',
  ...
  'Rodaja cocida de rejo, lista para tapas y ensaladas.',
  'Cooked tentacle slice, ready for tapas and salads.',
  21.00, ARRAY['IQF','Cocido'],'Perú','87',
  'Cocido · glaseo a la carta',
  'IQF bolsas 500 gr–1 kg o cajas a granel 7 kg',
  null,'Alto 0,2–0,8 cm · diámetro 1,5–3,5 cm',
  false, true, true),
...
('dados',
  ...
  'Cubo regular de 2 cm, ideal para brochetas y mixtos.',
  'Even 2 cm cube, ideal for skewers and mixes.',
  15.00, ARRAY['IQF'],'Perú','87',
  'Con o sin membrana',
  'A granel cajas 7 kg o bolsas 500 gr–1 kg',
  null,'Alto 2 cm · ancho 2 cm · grosor natural',
  false, true, true),
...
('rabas',
  ...
  'Bastón fino para freír — la raba clásica de barra.',
  'Fine stick for frying — the classic bar-style raba.',
  15.50, ARRAY['IQF'],'Perú','87',
  'Con o sin membrana y telilla',
  'A granel cajas 7 kg o bolsas 500 gr–1 kg',
  null,'Largo 6–8 cm · ancho 1 cm · grosor natural',
  true, true, true),
...
('tiras',
  ...
  'Con o sin membrana y telilla',
  'A granel cajas 7 kg o bolsas 500 gr–1 kg',
  null,'Largo 8–12 cm · ancho 2 cm · grosor natural',
  false, true, true)

on conflict (slug) do update set
  name_es=excluded.name_es, name_en=excluded.name_en, price=excluded.price,
  blurb_es=excluded.blurb_es, blurb_en=excluded.blurb_en,
  description_es=excluded.description_es, description_en=excluded.description_en,
  featured=excluded.featured;

-- ── CALAMAR / SQUID & CUTTLEFISH (2) ─────────────────────────
insert into public.products
  (slug, category_id, name_es, name_en, scientific_name, description_es, description_en, blurb_es, blurb_en,
   price, tags, origin, fao_zone, presentation, packaging, sizing, measures, featured, retail, active)
values
...
('loligo',
  (select id from categories where slug='calamar'),
...
('mahimahi',
  (select id from categories where slug='pescado'),
  ...
  'Filete con piel 3–5 / 5–7 / 7–9 lb · porciones', null,
  true, true, true),
...
('anchoveta',
  ...
  'Pelágico azul peruano, alto omega-3, para conserva y curado.',
  'Peruvian blue pelagic, high omega-3, for canning and curing.',
  6.50, ARRAY['Bloque'],'Perú','87',
  'Entera con branquias y vísceras',
  'Sacos de 20 kg: 2 bloques de 10 kg',
  'Entera 12 cm/pz a más', null,
  false, true, true),
...
('sardina-vz',
  ...
  'Sardina del Caribe, entera o eviscerada, lista para conserva.',
  'Caribbean sardine, whole or gutted, canning-ready.',
  7.00, ARRAY['Bloque'],'Venezuela','31',
  'Entera y eviscerada',
  'Sacos de 20 kg: 2 bloques de 10 kg',
  null, null,
  false, true, true),
...
('rape',
  ...
  'Cola de rape de carne magra y firme, gourmet europeo.',
  'Lean firm monkfish tail, a European gourmet cut.',
  38.00, ARRAY['IQF'],'África','34',
  'Entero IWP eviscerado · cola sin piel HGT',
  'Cajas de 20 kg',
  'Cola 250 gr a 2 kg a más', null,
  true, true, true),
...
('cachua',
  ...
  'Pez ballesta de carne blanca, excelente rendimiento en HGT.',
  'White-meat filefish, great HGT yield.',
  12.00, ARRAY['IQF','Bloque'],'Venezuela','31',
  'HGT o WR',
  'Cajas de 10 kg',
  'Entero 0,5–6 kg a más', null,
  false, true, true),
...
('tahali',
  ...
  'Pez cinta plateado, muy demandado en mercados asiáticos.',
  'Silver ribbonfish, in high demand across Asian markets.',
  9.50, ARRAY['Bloque'],'Atlántico','31',
  'Entero o HGT en IWP',
...
('pargo',
  ...
  'Pargo rojo de piel intensa, estrella de mesa premium.',
  'Deep-red snapper, a premium table star.',
  29.00, ARRAY['Bloque'],'Caribe','31',
  'Entero WGGS en IWP',
  'Entero en cajas de 10 o 20 lb',
  'S 300–500 · M 500–700 · L 700 gr–1 kg a más', null,
  false, true, true),
...
('pejerrey',
  ...
  'Pejerrey IQF talla pareja, frito o a la plancha.',
  'Even-size IQF silverside, fried or grilled.',
  11.00, ARRAY['IQF'],'Perú','87',
  'Entera con branquias · HG y HGT',
...
('corvina',
  ...
  'Corvina de carne magra, filete IVP sin espinas.',
  'Lean corvina, boneless IVP fillet.',
  26.00, ARRAY['IQF'],'Atlántico','31',
  'Entero o filete sin espinas',
  'IVP filetes en cajas de 10, 20 o 60 lb',
  'Filete 4–6 / 6–8 / 8–10 / 10–12 oz', null,
  false, true, true),
...
('pez-sierra',
  ...
  'Sierra firme en ruedas, ideal para grill y ceviche.',
  'Firm kingfish steaks, ideal for grill and ceviche.',
  15.00, ARRAY['IQF'],'Pacífico','31',
  'Entero o en ruedas',
  'IWP en cajas de 60 lb',
  'T1 3–5 · T2 5–10 · T3 10–15 lb a más', null,
  false, true, true)
...
('concha',
  (select id from categories where slug='marisco'),
  ...
  'Media concha 10–20 a 80–100 lb/pz', null,
  true, true, true),
...
('langosta',
  ...
  'Langosta cruda entera o cola, calibrada por tallas. Lujo de exportación.',
  'Raw whole lobster or tail, size-graded. Export luxury.',
  95.00, ARRAY['IQF'],'Caribe','31',
  'Entera cruda y cola cruda',
  'IWP en cajas',
  'Entera T1 12–14 oz a T10 · cola T1 6 oz a más', null,
  true, true, true),
...
('pulpo',
  ...
  'Pulpo entero por tallas, carne tierna. Corte flor a pedido.',
  'Whole octopus graded by size, tender meat. Flower cut on request.',
  33.00, ARRAY['IQF','Bloque'],'Perú · África','34',
  'Entero',
  'Entero en sacos de 20 kg: 2 bloques de 10 kg',
  'Entero T8 0,3 kg a T1 +4 kg · flor', null,
  true, true, true),
...
('pulpo-bandeja',
  ...
  'Pulpo entero presentado en bandeja, retail premium.',
  'Whole octopus tray-packed, premium retail.',
  36.00, ARRAY['IQF'],'Perú','34',
  'Entero en bandeja',
  '3 a 6 bandejas por caja según talla',
  '1–2 · 2–4 · 4–6 · 6–8 lb a más', null,
  false, true, true),
...
('pata-pulpo',
  ...
  'Pata de pulpo cocida estilo gallego, lista para emplatar.',
  'Galician-style cooked octopus leg, plate-ready.',
  58.00, ARRAY['IQF','Cocido'],'España','34',
  'Cocida',
  'Caja máster: 10 bolsas de 1 lb',
  'T2 3–4 · T3 2–3 · T4 1,5–2 · T5 2 kg a más', null,
  false, true, true)
...
('ovas',
  (select id from categories where slug='ovas'),
...
('romana',
  (select id from categories where slug='preparados'),
  ...
  'Anilla rebozada lista para freír, valor agregado europeo.',
  'Battered ring ready to fry, European value-added.',
  19.50, ARRAY['IQF','Prefrito'],'España','87',
  'Prefritas y ultracongeladas',
  'Bolsas de 0,5–1 kg o caja máster de 5 kg',
  null,'Diám. ext. 5–6 cm · int. 2,5–3 cm',
  true, true, true),
